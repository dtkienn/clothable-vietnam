...
theme.Header = (function() {
  ...
  function showDropdown(element) {
    document.querySelector('body').classList.add('show-dropdown-menu');
  ...
  function hideDropdown() {
    ...
    document.querySelector('body').classList.remove('show-dropdown-menu');
...
theme.MobileNav = (function() {
  ...
  function openMobileNav() {
    ...
    cache.mobileNavContainer.style.height = 'calc(100vh - ' + translateHeaderHeight + 'px)';
  ...
  function toggleSubNav(event) {
    ...
    if (isReturn) {
      cache.siteHeader.classList.remove('submenu-open');
      ...
      cache.siteHeader.classList.add('submenu-open');
...
theme.SearchDrawer = (function() {
  ...
  function init() {
    ...
    document.querySelector('.js-search-popup').addEventListener('click', function() {
      document.querySelector('body').classList.add('search-drawer-open');
      theme.MobileNav.closeMobileNav();
      lockBodyScroll();
    });

    document.querySelector('.search-popup-bg').addEventListener('click', function() {
      document.querySelector('body').classList.remove('search-drawer-open');
      unlockBodyScroll();
    });

    document.querySelector('.js-search-drawer-close').addEventListener('click', function() {
      document.querySelector('body').classList.remove('search-drawer-open');
      unlockBodyScroll();
    });
  }
...
theme.customerTemplates = (function() {
  ...
  function customerAddressForm() {
    ...
    document.querySelector('.text-link.address-new-toggle').addEventListener('click', function() {
      document.querySelector('.btn.address-new-toggle').classList.toggle('hide');
      console.log('haha');
    })
    document.querySelector('.btn.address-new-toggle').addEventListener('click', function() {
      document.querySelector('.btn.address-new-toggle').classList.toggle('hide');
      console.log('haha');
    })
  ...
  Product.prototype = Object.assign({}, Product.prototype, {
    ...
    _swatch: function() {
      $('.swatch :radio').change(function() {
        ...
        $(this).closest('.swatch').find('.js-swatch-selected').text(optionValue);

        const e = new Event("change");
        const selectElement = document.querySelector('.single-option-selector[data-index0="'+optionIndex+'"]');
    ...
    _initMobileBreakpoint: function() {
      if (this.mqlSmall.matches) {
        ...
        if(!$('.product-featured-media-wrap-js').hasClass('slick-slider')) {
          $('.product-featured-media-wrap-js').slick({
            infinite: false,
            slidesToShow: 1,
            slidesToScroll: 1,
            arrows: true,
            prevArrow: '<button type="button" class="slick-prev"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.4396 0.439453L17.5609 2.56077L8.12155 12.0001L17.5609 21.4395L15.4396 23.5608L3.87891 12.0001L15.4396 0.439453Z" fill="#212121"/></svg></button>',
            nextArrow: '<button type="button" class="slick-next"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.56043 0.439453L6.43911 2.56077L15.8785 12.0001L6.43911 21.4395L8.56043 23.5608L20.1211 12.0001L8.56043 0.439453Z" fill="#212121"/></svg></button>',
            dots: false
          })
        }
        ...
        if($('.product-featured-media-wrap-js').hasClass('slick-slider')) {
          $('.product-featured-media-wrap-js').slick('unslick');
        }
    ...
    _setupCartDrawer: function() {
      ...
      fetch('/cart?view=drawer&timestamp=' + Date.now(), {
        ...
        content.text().then(function (html) {
          $('#sidebar-cart .cart-content').html(html);
...
theme.ProductRecommendations = (function() {
  ...
  function recommendedSlide() {
    let $slider = $('#RecommendationsSlide'),
        $prevArrow = $('#RecommendationsSlide-prev'),
        $nextArrow = $('#RecommendationsSlide-next');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  sections.register('leather-section', theme.Product);
